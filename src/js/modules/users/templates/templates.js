...
module.run(['$templateCache', function($templateCache) {
  $templateCache.put('users.item.delete.tpl.html',
    ...
    '{{ user | json }}\n' +
    '</pre><ul class=page-nav><li class=page-nav__item><a href=# ng-click=confirm($event) ng-disabled=disable>Delete</a></li></ul>');
}]);
})();
